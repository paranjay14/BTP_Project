...
def getOptions(args=sys.argv[1:]):
    ...
    parser.add_argument("-cB", "--cnnBatches", type=int, help="No. of Batches in CNN", default=800)
    parser.add_argument("-mB", "--mlpBatches", type=int, help="No. of Batches in MLP", default=800)
